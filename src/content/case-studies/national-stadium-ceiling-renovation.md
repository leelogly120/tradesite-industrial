...
stats:
  ...
  - num: "30%"
    label: "Faster Than Scaffolding"
  - num: "Zero"
    label: "Safety Incidents"
results:
  - num: "45 days"
    label: "Completed (vs 65 days planned)"
  - num: "$200K+"
    label: "Cost Savings"
  - num: "Zero"
    label: "Safety Incidents"
...
- 35m working height with complex steel truss structure
- Floor protection required — premium seating and playing surface
- Tight 45-day deadline before upcoming events
- Safety — zero tolerance for incidents at this height
- Acoustic panel installation required precise positioning
...
- Dual power system — electric mode for zero indoor emissions
- Full remote control — operator safely on ground level
- Non-marking rubber tracks for floor protection

> "The pick & carry capability was a game-changer. We saved over $200,000 in labor costs compared to our original scaffolding estimate, and completed 20 days ahead of schedule."
> — Project Manager, Stadium Modernization Team
...
- **Power:** Diesel + Electric (dual mode)
