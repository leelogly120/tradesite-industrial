...
describe('public asset manifest', () => {
  ...
  it('preserves the original 15 editorial assets and publishes the 54 approved long-form assets', async () => {
    ...
    const expectedRecoveredAssets = RECOVERED_RANKED_ARTICLES.map(({ slug, diagram }) => [
      slug,
      `/images/editorial/${diagram}`,
    ]);
    const expectedNewAssets = [...expectedTask7Assets, ...expectedTask8Assets, ...expectedLiftPlatformAssets, ...expectedRecoveredAssets];
